...
class HealthDrinks: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_health_drinks)

        recyclerView = findViewById(R.id.Health_care_recycler_view)
