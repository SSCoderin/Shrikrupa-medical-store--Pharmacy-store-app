package com.shiv.shrikrupamedical.healthcare
...
class kneepain: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kneepain)
        ...
        webView.loadUrl("https://sscoderin.github.io/healthcare/kneecare.html")
    }
